<div class="modal fade"  id="_formCheque" tabindex="-1" role="dialog" aria-labelledby="FormularioDeCheques">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group row">
									...
									{!! Form::select('banco_id', $bancos, null, ['class' => 'form-control m-input', 'required'])!!} 
									</div>
								</div>
							</div>
						</div>
