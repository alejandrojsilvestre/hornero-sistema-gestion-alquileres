...
function renderParsedFormat(parsedFormat, date1, date2, separator, isRTL) {
    ...
    return processMayobeMarkers(leftStr + middleStr + rightStr);
}
...
function renderFakeFormatString(fakeFormatString, date) {
    return processMayobeMarkers(renderFakeFormatStringParts(fakeFormatString, date).join(''));
}
/*
...
*/
function processMayobeMarkers(s) {
